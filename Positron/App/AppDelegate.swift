...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    public static let navigation = UINavigationController.init(rootViewController: UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "Initial"))
